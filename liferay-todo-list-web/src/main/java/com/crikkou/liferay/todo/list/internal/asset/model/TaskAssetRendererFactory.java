package com.crikkou.liferay.todo.list.internal.asset.model;

import com.crikkou.liferay.todo.list.constants.ToDoListConstants;
import com.crikkou.liferay.todo.list.constants.ToDoListPortletKeys;
import com.crikkou.liferay.todo.list.constants.TodoListActionKeys;
...
public class TaskAssetRendererFactory extends BaseAssetRendererFactory<Task> {
		...
		TaskAssetRenderer taskAssetRenderer = new TaskAssetRenderer(
			...
			ResourceBundleLoaderUtil.
				getResourceBundleLoaderByBundleSymbolicName(
					"com.crikkou.liferay.todo.list.web"));
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.crikkou.liferay.todo.list.web)"
	)
